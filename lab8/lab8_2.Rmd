...
```{r}
lizard_seq <- read.GenBank("JQ073190", as.character = T)
write.fasta(names = "LIZ-1", sequences = lizard_seq, file.out="data/liz1.fasta")
lizard_seq2 <- read.fasta(file = "data/liz1.fasta")
lizard_seq3 <- lizard_seq2[[1]]
```
