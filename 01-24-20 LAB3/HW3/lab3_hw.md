...
## Question 2
### Use `spec()` to see the full details of the columns.  
...
## Question 6
### Make a new dataframe `deer` that is limited to the mean mass, log10 mass, family, genus, and species of deer in the database. The family for deer is cervidae. Arrange the data in descending order by log10 mass. Which is the largest deer?  
...
## Question 7
### As measured by the data, which snake species has the smallest homerange? Show all of your work, please. Look this species up online and tell me about it!  


```r
snake_hra <- homerange %>%
  select(mean.hra.m2, log10.hra, taxon, family, genus, species) %>%
  filter(taxon == "snakes") %>%
  arrange(log10.hra)
snake_hra
```
...
```
## # A tibble: 41 x 6
##    mean.hra.m2 log10.hra taxon  family     genus       species     
##          <dbl>     <dbl> <chr>  <chr>      <chr>       <chr>       
##  1        200       2.30 snakes viperidae  bitis       schneideri  
##  2        253       2.40 snakes colubridae carphopis   viridis     
##  3        600       2.78 snakes colubridae thamnophis  butleri     
##  4        700       2.85 snakes colubridae carphopis   vermis      
##  5       2400       3.38 snakes viperidae  vipera      latastei    
##  6       2614.      3.42 snakes viperidae  gloydius    shedaoensis 
##  7       6476       3.81 snakes colubridae diadophis   punctatus   
##  8      10655       4.03 snakes viperidae  agkistrodon piscivorous 
##  9      15400       4.19 snakes colubridae oocatochus  rufodorsatus
## 10      17400       4.24 snakes colubridae pituophis   catenifer   
## # … with 31 more rows
```
This may be the world's smallest viper!!! Habitat destruction and illegal collecting of this animal has made their conservation status vulnerable.

## Question 8
### You suspect that homerange and mass are correlated in birds. We need a ratio that facilitates exploration of this prediction. First, build a new dataframe called `hra_ratio` that is limited to genus, species, mean.mass.g, log10.mass, log10.hra. Arrange it in ascending order by mean mass in grams.  


```r
hra_ratio <- homerange %>%
  select(taxon, genus, species, mean.mass.g, log10.mass, log10.hra) %>%
  filter(taxon == "birds") %>%
  arrange(mean.mass.g)
hra_ratio
```
...
```
## # A tibble: 140 x 6
##    taxon genus        species      mean.mass.g log10.mass log10.hra
##    <chr> <chr>        <chr>              <dbl>      <dbl>     <dbl>
##  1 birds regulus      regulus             5.15      0.712      4.30
##  2 birds regulus      ignicapillus        5.3       0.724      4.22
##  3 birds phylloscopus bonelli             7.5       0.875      4.54
##  4 birds aegithalos   caudatus            8         0.903      4.62
##  5 birds vireo        atricapillus        8.5       0.929      4.18
##  6 birds setophaga    magnolia            8.6       0.934      3.86
##  7 birds certhia      familiaris          8.77      0.943      4.67
##  8 birds sylvia       undata              8.8       0.944      3.45
##  9 birds setophaga    ruticilla           9         0.954      3.29
## 10 birds setophaga    virens              9         0.954      3.81
## # … with 130 more rows
```

## Question 9
### Replace the existing `hra_ratio` dataframe with a new dataframe that adds a column calculating the ratio of log 10 hra to log 10 mass. Call it `hra.mass.ratio`. Arrange it in descending order by mean mass in grams.  


```r
hra_mass_ratio <- hra_ratio %>%
...
## Question 10
### What is the lowest mass for birds with a `hra.mass.ratio` greater than or equal to 4.0?
...
```
## # A tibble: 17 x 7
##    taxon genus       species     mean.mass.g log10.mass log10.hra hra.mass.ratio
##    <chr> <chr>       <chr>             <dbl>      <dbl>     <dbl>          <dbl>
##  1 birds regulus     regulus            5.15      0.712      4.30           6.04
##  2 birds regulus     ignicapill…        5.3       0.724      4.22           5.82
##  3 birds phylloscop… bonelli            7.5       0.875      4.54           5.19
##  4 birds aegithalos  caudatus           8         0.903      4.62           5.12
##  5 birds vireo       atricapill…        8.5       0.929      4.18           4.49
##  6 birds setophaga   magnolia           8.6       0.934      3.86           4.13
##  7 birds certhia     familiaris         8.77      0.943      4.67           4.95
##  8 birds wilsonia    canadensis         9.3       0.968      4.01           4.14
##  9 birds troglodytes troglodytes        9.5       0.978      4.01           4.10
## 10 birds cisticola   juncidis           9.8       0.991      4.16           4.20
## 11 birds vireo       belli             10         1          4.07           4.07
## 12 birds parus       carolinens…       10.1       1.00       4.18           4.16
## 13 birds hippolais   polyglotta        11         1.04       4.48           4.30
## 14 birds parus       palustris         11         1.04       4.36           4.18
## 15 birds spizella    passerina         12.2       1.09       4.49           4.13
## 16 birds contopus    virens            13.8       1.14       4.64           4.07
## 17 birds motacilla   alba              21.2       1.33       5.89           4.44
```

## Question 11
### Do a search online; what is the common name of the bird from #8 above? Place a link in your markdown file that takes us to a webpage with information on its biology.  

https://www.hbw.com/species/goldcrest-regulus-regulus

## Question 12
### What is the `hra.mass.ratio` for an ostrich? Show your work, please.  
...
##   taxon genus    species mean.mass.g log10.mass log10.hra hra.mass.ratio
##   <chr> <chr>    <chr>         <dbl>      <dbl>     <dbl>          <dbl>
## 1 birds struthio camelus       88250       4.95      7.93           1.60
```
