...
```{r}
total_harry_potter_matrix<- rbind(all_harry_potter_matrix, Totals)
```
```{r}
...
```{r}
temperature_vector<- c(spring_1, spring_2, spring_3, spring_4, spring_5, spring_6, spring_7, spring_8)

temperature_matrix<- matrix(temperature_vector, nrow = 8, byrow = TRUE)
temperature_matrix
```
